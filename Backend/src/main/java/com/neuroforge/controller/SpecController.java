...
public class SpecController {
    ...
    @PreAuthorize("hasAnyRole('PROJECT_MANAGER','ORG_ADMIN','SUPER_ADMIN','DEVELOPER', 'FRONTEND_DEVELOPER', 'BACKEND_DEVELOPER','QA_TESTER','CLIENT','USER','ROLE_USER')")
    ...
    @PreAuthorize("hasAnyRole('PROJECT_MANAGER','ORG_ADMIN','SUPER_ADMIN','USER','ROLE_USER','DEVELOPER', 'FRONTEND_DEVELOPER', 'BACKEND_DEVELOPER')")
